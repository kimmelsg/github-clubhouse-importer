...
const cli = meow(
  `
    ...
    --clubhouse-project=<name>   Name of Clubhouse Project to import issues into
    --state=<open|closed|all>    Github issue state to import

	Examples
	  $ ghch --state=open --github-url=facebook/react --clubhouse-project=myproject --github-token=xxx --clubhouse-token=xxx
`,
  {
    flags: {
      githubToken: {
